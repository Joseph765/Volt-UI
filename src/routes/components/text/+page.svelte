<script>
    ...
    <Text size="l">This is l sample text</Text>
    <Text size="xl">This is xl sample text</Text>
...
<Flex direction="column" gap="xl">
    <Flex direction="column">
        <Text size="3xl" weight="black" as="h2">Text</Text>
    ...
    <Flex direction="column">
        ...
        {:else if selectedExample === "weight"}
